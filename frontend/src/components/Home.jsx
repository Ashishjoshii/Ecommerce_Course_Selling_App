    ...
    <div className="bg-gradient-to-r from-black to-blue-950 ">
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center py-20">
          <Link to={"/"} className="text-4xl font-semibold text-orange-500">
            CourseNova
          </Link>
                  ...
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      {isLoggedIn ? (
                        ...
                        <Link to={`/login`} className="mt-8 bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-500 duration-300">
                          Enroll Now
                        </Link>
                      )}
                    </div>
